<%@ Page language="c#" Codebehind="dialog.aspx.cs" AutoEventWireup="false" Inherits="IRSA.Multipay.Administration.Dialog" %>
	...
	<body style="OVERFLOW: hidden">
		<form id="Form1" method="post" runat="server">
			<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="window">
				...
				<tbody>
					<tr align="center">
						<td><div id="tdContents" style="OVERFLOW-Y: auto; OVERFLOW-X: hidden; OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%; TEXT-ALIGN: left"></div>
						</td>
					</tr>
					<tr>
