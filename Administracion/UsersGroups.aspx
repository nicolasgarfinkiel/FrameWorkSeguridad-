												...
												<td align="center" valign="middle"><table>
														<tr>
															<td valign="top" align="center"><table>
																	<tr>
																		<td style="HEIGHT: 20px" align="right"><asp:label id="Label1" runat="server" cssclass="label">Aplicación</asp:label></td>
																...
																<asp:CheckBox id="chkEnabledUsers" runat="server" TextAlign="Left" Text="Sólo usuarios con permisos"
