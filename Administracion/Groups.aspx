<%@ Page language="c#" Codebehind="Groups.aspx.cs" AutoEventWireup="false" Inherits="IRSA.Framework.Services.Administracion.GroupsPage" %>
							...
							<tr>
								<td><table width="100%">
										<thead>
											<tr>
												<th>
													<asp:label id="lblTitle" runat="server" CssClass="label">Grupos</asp:label></th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td align="center" valign="middle"><table>
														<tr>
															<td valign="top"><table>
																	<tr>
																		<td style="HEIGHT: 17px" align="right"><asp:label id="Label1" runat="server" cssclass="label">Aplicación</asp:label></td>
																	...
																	<tr>
																		<td style="HEIGHT: 15px" align="right"><asp:label id="lblName" runat="server" cssclass="label">Descripción</asp:label></td>
															...
															<td valign="top"><table cellpadding="0" cellspacing="0" id="tblDetail" runat="server">
																	<tr>
																		<td><cc1:customdatagrid id="grdDetail" runat="server" CssClass="grid" AutoGenerateColumns="False" UseAccessibleHeader="True"
																				Width="100%" PageSize="5" AllowPaging="True" ShowHeader="False" Title="Permisos">
