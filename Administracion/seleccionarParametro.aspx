...
<%@ Page language="c#" Codebehind="seleccionarParametro.aspx.cs" AutoEventWireup="false" Inherits="IRSA.Framework.Services.Administracion.seleccionarParametro" %>
	...
	<HEAD>
		...
		<!--
			...
			function OK_onClick(parentInstance)
			{
				...
				window.returnValue = "key=" + txtKey.value + ";value=" + txtValue.value;
			}
