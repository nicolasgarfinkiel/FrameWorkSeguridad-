...
<%@ Page language="c#" Codebehind="SeleccionarPermiso.aspx.cs" AutoEventWireup="false" Inherits="IRSA.Framework.Services.Administracion.Dialogs.SeleccionarPermiso" %>
...
<HTML>
	<HEAD>
		...
		<!--
			...
			{
				var cbo = document.getElementById("cboPermiso");
				
				window.returnValue = "permission=" + cbo.value.toString();
			}
		...
		<form id="Form1" method="post" runat="server">
			<table class="window" width="100%" height="100%">
				<thead>
					<tr>
						<th colspan="2">
							Seleccione un Permiso</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><asp:label id="lblAtributo" runat="server" cssclass="label">Permiso</asp:label></td>
						<td><asp:dropdownlist id="cboPermiso" runat="server" width="200px" cssclass="box"></asp:dropdownlist></td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
